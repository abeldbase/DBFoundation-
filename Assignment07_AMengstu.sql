...
-- 2022-03-01,AMengstu,Complet file *****************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_AMengstu')
	 Begin 
	  Alter Database [Assignment07DB_AMengstu] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_AMengstu;
	 End
	Create Database Assignment07DB_AMengstu;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_AMengstu;
...
View vProductInventoriesWithPreviousMonthCountsWithKPIs
	AS 
	Select Top 10000000 [ProductName],
	[InventoryDate],
	[InventoryCount],
	[PreviousMonthCount],
